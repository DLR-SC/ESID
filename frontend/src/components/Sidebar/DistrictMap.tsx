...
export default function DistrictMap(): JSX.Element {
  ...
  useEffect(() => {
    ...
    const existingZoomButton = chart.get('zoomControl')?.plusButton
    const settingsButton = am5.Button.new(root, {
      dx: existingZoomButton?.get('dx'),
      dy: existingZoomButton?.get('dy'),
      layer: existingZoomButton?.get('layer'),
      paddingBottom: existingZoomButton?.get('paddingBottom'),
      paddingLeft: existingZoomButton?.get('paddingLeft'),
      paddingRight: existingZoomButton?.get('paddingRight'),
      paddingTop: existingZoomButton?.get('paddingTop'),
      width: existingZoomButton?.get('width'),
      height: existingZoomButton?.get('height'),
